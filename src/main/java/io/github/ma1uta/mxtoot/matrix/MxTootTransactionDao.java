 ...
 */
public class MxTootTransactionDao extends AbstractDAO<MxTootTransaction> implements TransactionDao<MxTootTransaction> {
     ...
     */
    public MxTootTransactionDao(SessionFactory sessionFactory) {
     ...
     */
    public void save(MxTootTransaction transaction) {
        persist(transaction);
    }
